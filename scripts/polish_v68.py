...
# One conversion point after the three-person team
...
checks = [
    ...
    ('BUL / LOCAL SNS' in s, 'BUL label replacement was not applied'),
    ('3人タッグに相談する' in s, 'Team CTA was not added'),
